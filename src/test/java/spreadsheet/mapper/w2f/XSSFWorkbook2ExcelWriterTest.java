...
import spreadsheet.mapper.f2w.Excel2WorkbookReader;
import spreadsheet.mapper.f2w.WorkbookReader;
...
public class XSSFWorkbook2ExcelWriterTest {
  ...
  public void testWrite() throws Exception {
    ...
    WorkbookWriter workbookWriter = new XSSFWorkbook2ExcelWriter();
