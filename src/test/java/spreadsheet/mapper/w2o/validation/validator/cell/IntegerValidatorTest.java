...
public class IntegerValidatorTest {
  ...
  public void testCustomValidate() throws Exception {
    ...
    CellValidator[] validator = new IntegerValidator()
    ...
    assertFalse(validator[4].valid(cellMap1.get("test.float1"), fieldMetaMap.get("test.float1")));
    assertFalse(validator[5].valid(cellMap1.get("test.float2"), fieldMetaMap.get("test.float2")));
    assertFalse(validator[6].valid(cellMap1.get("test.double1"), fieldMetaMap.get("test.double1")));
    assertFalse(validator[7].valid(cellMap1.get("test.double2"), fieldMetaMap.get("test.double2")));
