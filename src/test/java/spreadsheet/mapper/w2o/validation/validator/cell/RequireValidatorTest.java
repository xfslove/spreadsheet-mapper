...
public class RequireValidatorTest {
  ...
  public void testValid() throws Exception {
    ...
    CellValidator[] validator = new RequireValidator()
    ...
    assertFalse(validator[1].valid(cellMap2.get("test.int2"), fieldMetaMap.get("test.int2")));
    assertTrue(validator[2].valid(cellMap2.get("test.long1"), fieldMetaMap.get("test.long1")));
    assertFalse(validator[3].valid(cellMap2.get("test.long2"), fieldMetaMap.get("test.long2")));
    assertTrue(validator[4].valid(cellMap2.get("test.float1"), fieldMetaMap.get("test.float1")));
    assertFalse(validator[5].valid(cellMap2.get("test.float2"), fieldMetaMap.get("test.float2")));
    assertTrue(validator[6].valid(cellMap2.get("test.double1"), fieldMetaMap.get("test.double1")));
    assertFalse(validator[7].valid(cellMap2.get("test.double2"), fieldMetaMap.get("test.double2")));
  }
