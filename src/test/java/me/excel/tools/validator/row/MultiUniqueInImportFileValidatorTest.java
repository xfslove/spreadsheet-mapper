...
public class MultiUniqueInImportFileValidatorTest {
  ...
  public void testCustomValidate() throws Exception {
    ...
    CellBean e1 = new CellBean(1, 1, "person.name", "1");
    CellBean e2 = new CellBean(1, 2, "person.age", "1");
    r1.addCell(e1);
    r1.addCell(e2);

    CellBean e3 = new CellBean(2, 1, "person.name", "1");
    CellBean e4 = new CellBean(2, 2, "person.age", "2");
    r2.addCell(e3);
    r2.addCell(e4);

    CellBean e5 = new CellBean(3, 1, "person.name", "1");
    CellBean e6 = new CellBean(3, 2, "person.age", "2");
    r3.addCell(e5);
    r3.addCell(e6);
