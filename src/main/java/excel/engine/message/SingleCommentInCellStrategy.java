...
public class SingleCommentInCellStrategy implements MessageWriteStrategy {
  ...
  public void write(OutputStream outputStream, Collection<ErrorMessage> errorMessages) {
    ...
    List<excel.engine.model.shapes.Comment> comments = transferToComments(errorMessages);
  ...
  private List<excel.engine.model.shapes.Comment> transferToComments(Collection<ErrorMessage> errorMessages) {
    ...
    List<excel.engine.model.shapes.Comment> comments = new ArrayList<>();
  ...
  private void addComment(Sheet sheet, excel.engine.model.shapes.Comment comment) {
