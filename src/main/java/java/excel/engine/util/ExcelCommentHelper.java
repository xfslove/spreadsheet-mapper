...
public class ExcelCommentHelper {
   ...
   */
  public static void writeComments(File file, Collection<java.excel.engine.model.shape.Comment> comments) {
   ...
   * @param comments     comments
   */
  public static void writeComments(InputStream inputStream, OutputStream outputStream, Collection<java.excel.engine.model.shape.Comment> comments) {
  ...
  private static void addComments(Workbook workbook, Collection<java.excel.engine.model.shape.Comment> comments) {
    int numberOfSheets = workbook.getNumberOfSheets();

    for (java.excel.engine.model.shape.Comment comment : comments) {
  ...
  private static void addComment(Sheet sheet, java.excel.engine.model.shape.Comment comment) {
    if (comment == null) {
      return;
    }
